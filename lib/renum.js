...
NewNumbers.prototype.writeResultCSV = function (knoopByCode, linkByCode, outDir) {
    ...
    Object.keys(knoopByCode).forEach(function (code) {
        ...
        knopen.push([knoop.code, knoop.id,
    ...
    Object.keys(linkByCode).forEach(function (lnkcode) {
        ...
        //"pid", "code", "startcode", "endcode", "startnr", "endnr", "oldstatus", "newstatus", "change", "ok"
        links.push([ link.pid, link.code, link.start.code, link.end.code, minnr, maxnr,
    ...
    rwcsv.write(path.join(outDir, "result-knoop.csv"), knopen,
                ["code", "id", "oldnr", "newnr", "oldstatus", "newstatus", "change", "ok"]);
    rwcsv.write(path.join(outDir, "result-link.csv"), links,
                ["pid", "code", "startcode", "endcode", "startnr", "endr", "oldstatus", "newstatus", "change", "ok"]);
