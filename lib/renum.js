...
NewNumbers.prototype.writeResultCSV = function (knoopByCode, linkByCode, outDir) {
    ...
    Object.keys(linkByCode).forEach(function (lnkcode) {
        ...
        //"pid", "startcode", "endcode", "startnr", "endnr", "oldstatus", "newstatus", "change", "ok"
        links.push([ link.pid, link.start.code, link.end.code, link.start.newnr, link.end.newnr,
    ...
    for (nr = 1; nr < 100; nr += 1) {
        ...
        stats.push([nr, cnt, mindist, (100 - friends.length)]);
    }
    ...
    rwcsv.write(path.join(outDir, "result-link.csv"), links,
                ["pid", "startcode", "endcode", "startnr", "endr", "oldstatus", "newstatus", "change", "ok"]);
